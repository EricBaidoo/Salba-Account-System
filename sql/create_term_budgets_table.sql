-- Simplified Semester Budget Tables

-- Main budget table for each semester
CREATE TABLE IF NOT EXISTS `term_budgets` (
  ...
  UNIQUE KEY `unique_term_year` (`semester`, `academic_year`),
  INDEX `idx_term_year` (`semester`, `academic_year`),
