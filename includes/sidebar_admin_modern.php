...
<aside id="sidebar-modern" class="fixed left-0 top-0 bottom-0 w-72 bg-slate-950 z-50 flex flex-col border-r border-slate-900 transform -translate-x-full lg:translate-x-0">
    ...
    <nav class="flex-1 overflow-y-auto px-4 pb-8 custom-scrollbar">
        ...
        <a href="<?= nav_link($base_path, 'administration/students/promote_students') ?>" class="nav-item <?= nav_active('promote_students', $current_page) ?>">
            <i class="fas fa-arrow-trend-up"></i>
            <span>Promote Learners</span>
        </a>
        ...
        <a href="<?= nav_link($base_path, 'academics/teacher_reports') ?>" class="nav-item <?= nav_active('teacher_reports', $current_page) ?>">
