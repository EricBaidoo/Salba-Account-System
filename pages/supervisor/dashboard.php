    ...
    <main class="admin-main-content p-4 md:p-8 w-full min-h-screen">
        ...
        <div class="max-w-6xl mx-auto p-4 md:p-10 -mt-6 md:-mt-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                ...
                <!-- Card: Weekly Reports (NEW) -->
                <a href="<?= BASE_URL ?>pages/supervisor/weekly_reports" class="relative group bg-white rounded-[2rem] p-8 border border-gray-100 shadow-sm hover:shadow-2xl hover:border-teal-300 transition-all duration-500 overflow-hidden text-center">
                    <div class="flex flex-col items-center gap-4 relative z-10">
                        <div class="w-16 h-16 bg-teal-50 text-teal-600 rounded-2xl flex items-center justify-center text-3xl shadow-inner group-hover:scale-110 transition-all"><i class="fas fa-clipboard-check"></i></div>
                        <div>
