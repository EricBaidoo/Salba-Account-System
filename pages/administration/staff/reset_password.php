...
<head>
    ...
    <style>body { font-family: 'Inter', sans-serif; } .fi { width:100%; padding:0.625rem 0.875rem; border:0.09375rem solid #e8e8f0; border-radius:0.625rem; font-size:0.875rem; font-weight:500; outline:none; transition:all .2s; background:#fafafa; } .fi:focus { border-color:#f59e0b; background:white; box-shadow:0 0 0 0.1875rem rgba(245,158,11,.08); } .fl { display:block; font-size:0.6875rem; font-weight:700; color:#8b8fa8; text-transform:uppercase; letter-spacing:.06em; margin-bottom:0.375rem; }</style>
</head>
