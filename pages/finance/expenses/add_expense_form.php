    ...
    <main class="admin-main-content lg:ml-72 p-4 md:p-8 p-10 min-h-screen">
        ...
        <header class="mb-12 flex justify-between items-end">
            ...
            <div class="flex gap-4">
                <a href="view_expenses.php" class="bg-white border border-slate-200 text-slate-600 font-black text-[0.625rem] uppercase tracking-widest px-8 py-4 rounded-2xl hover:bg-slate-50 transition-all leading-none">
        ...
        <form action="add_expense.php" method="POST" class="max-w-4xl">
            ...
            <section class="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm mb-10">
                <h3 class="text-[0.625rem] font-black text-slate-400 uppercase tracking-[0.3em] mb-8 flex items-center gap-3">
                    01. Classification & Purpose <span class="flex-1 h-[0.0625rem] bg-slate-100"></span>
                </h3>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <label class="text-[0.625rem] font-black text-slate-400 uppercase tracking-widest mb-3 block">Expense Classification</label>
                    ...
                    <div>
                        <label class="text-[0.625rem] font-black text-slate-400 uppercase tracking-widest mb-3 block">Maturity Value (GHS)</label>
                        <div class="relative">
                    ...
                    <div class="md:col-span-2">
                        <label class="text-[0.625rem] font-black text-slate-400 uppercase tracking-widest mb-3 block">Expenditure Narrative</label>
            ...
            <section class="bg-white rounded-[2.5rem] p-10 border border-slate-100 shadow-sm mb-12">
                <h3 class="text-[0.625rem] font-black text-slate-400 uppercase tracking-[0.3em] mb-8 flex items-center gap-3">
                    02. Temporal Context <span class="flex-1 h-[0.0625rem] bg-slate-100"></span>
                </h3>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <label class="text-[0.625rem] font-black text-slate-400 uppercase tracking-widest mb-3 block">Transaction Date</label>
                    ...
                    <div>
                        <label class="text-[0.625rem] font-black text-slate-400 uppercase tracking-widest mb-3 block">Semester</label>
                    ...
                    <div>
                        <label class="text-[0.625rem] font-black text-slate-400 uppercase tracking-widest mb-3 block">Academic Year</label>
                        ...
                        <p class="text-[0.5625rem] font-bold text-slate-400 mt-2 ml-1">Fixed to systemic year: <?= formatAcademicYearDisplay($conn, $academic_year) ?></p>
                    </div>
                </div>
            </section>
            ...
            <div class="bg-slate-900 rounded-[2.5rem] p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-2xl shadow-slate-900/20">
                ...
                <button type="submit" class="bg-rose-600 hover:bg-rose-500 text-white font-black text-[0.6875rem] uppercase tracking-[0.2em] px-10 py-5 rounded-2xl shadow-xl transition-all h-fit active:scale-95 leading-none">
