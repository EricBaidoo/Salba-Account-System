...
<body>
    <div class="max-w-7xl mx-auto mt-4 mb-">
        <div class="mb-">
            <a href="bulk_term_billing_form.php" class="px-4 py-2 border border-gray-300 rounded"><i class="fas fa-arrow-left mr-1"></i>Back to Form</a>
        </div>

        <div class="page-header rounded shadow-sm mb- p-4 text-center">
            <h2 class="mb-"><i class="fas fa-eye mr-2"></i>Bulk Billing Preview</h2>
            <p class="lead mb-">Review the assignments before confirming</p>
        </div>
        ...
        <!-- Summary bg-white rounded shadow -->
        <div class="summary-bg-white rounded shadow">
            <h4 class="mb-"><i class="fas fa-chart-bar mr-2"></i>Billing Summary</h4>
            <div class="flex flex-wrap gap-3">
                <div class="col-md-3">
                    <div class="stat-box">
                        <h3 class="mb-"><?php echo $total_assignments; ?></h3>
                        <small>New Assignments</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-box">
                        <h3 class="mb-"><?php echo $skipped_count; ?></h3>
                        <small>Skipped (Already Assigned)</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-box">
                        <h3 class="mb-"><?php echo $error_count; ?></h3>
                        <small>Skipped (Not Configured)</small>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-box">
                        <h3 class="mb-">GHâ‚µ<?php echo number_format(array_sum(array_column($preview_data, 'amount')), 2); ?></h3>
        ...
        <?php if ($total_assignments > 0): ?>
            <!-- Preview w-full border-collapse -->
            <div class="bg-white rounded shadow mb-">
                <div class="bg-white rounded shadow-header bg-primary text-white">
                    <h5 class="mb-"><i class="fas fa-list mr-2"></i>Assignments to be Created (<?php echo $total_assignments; ?>)</h5>
                </div>
                <div class="preview-w-full border-collapse">
                    <table class="w-full border-collapse w-full border-collapse-striped w-full border-collapse-hover mb-">
                        ...
                        <tbody>
                            ...
                            foreach ($preview_data as $item): 
                                if ($current_class !== $item['student_class']) {
                                    ...
                                    echo '<tr class="w-full border-collapse-secondary"><td colspan="4"><strong>' . htmlspecialchars($current_class) . '</strong></td></tr>';
                                }
                            ?>
                                <tr>
                                    ...
                                    <td class="text-right">GHâ‚µ<?php echo number_format($item['amount'], 2); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
            ...
            <form method="POST" action="bulk_term_billing.php">
                ...
                <div class="text-center">
                    <a href="bulk_term_billing_form.php" class="px-4 py-2 bg-gray-600 text-white rounded px-3 py-2 rounded-lg mr-2">
                        <i class="fas fa-times mr-1"></i>Cancel
                    </a>
                    <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 px-3 py-2 rounded-lg">
                        <i class="fas fa-check-circle mr-2"></i>Confirm & Assign <?php echo $total_assignments; ?> Fees
                    </button>
                </div>
            </form>
        <?php else: ?>
