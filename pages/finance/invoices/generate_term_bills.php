...
<body class="clean-body">
    <div class="clean-max-w-7xl mx-auto">
        ...
        <form method="POST" action="process_term_bills.php" id="termBillForm">
                ...
                <div class="clean-bg-white rounded shadow-body">
                    <div class="flex flex-wrap gap-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="clean-w-full px-3 py-2 border border-gray-300 rounded" name="academic_year" id="academic_year" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" class="clean-w-full px-3 py-2 border border-gray-300 rounded" name="due_date" id="due_date" required>
                        </div>
                        <div class="col-md-4">
                            <label class="clean-block text-sm font-medium mb-">
                                <i class="fas fa-filter"></i>Filter by Class
                            </label>
                            <select class="clean-w-full px-3 py-2 border border-gray-300 rounded" name="class_filter" id="class_filter">
                ...
                <div class="clean-bg-white rounded shadow-body">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <div class="md:col-span-6">
                            <div class="clean-select-bg-white rounded shadow" data-fee-id="<?php echo $fee['id']; ?>">
                                <div class="clean-select-bg-white rounded shadow-content">
                                    <div class="clean-select-bg-white rounded shadow-info">
                                        <h6><?php echo htmlspecialchars($fee['name']); ?> <?php echo $type_badge; ?></h6>
                                        <p class="clean-select-bg-white rounded shadow-amount"><?php echo $amount_display; ?></p>
                                        <?php if ($fee['amount_details']): ?>
                                            <small class="clean-select-bg-white rounded shadow-details"><?php echo htmlspecialchars($fee['amount_details']); ?></small>
                                        <?php endif; ?>
                                    </div>
            ...
            <div class="clean-bg-white rounded shadow">
                <div class="clean-bg-white rounded shadow-body text-center">
                    <div id="preview" class="clean-warning-box mb-" class="hidden">
                        <i class="fas fa-bolt"></i>
                        <strong>Ready to generate:</strong> <span id="feeCount">0</span> fees for <span id="studentCount">all active</span> students
                        <span class="ml-2">(Year: <span id="yearPreview"><?php echo htmlspecialchars($display_year); ?></span>)</span>
                    </div>
                    <button type="submit" class="clean-px-3 py-2 rounded-primary clean-px-3 py-2 rounded-lg" id="submitBtn" disabled>
                        <i class="fas fa-bolt"></i>
        ...
        const feeCards = document.querySelectorAll('.clean-select-bg-white rounded shadow');
