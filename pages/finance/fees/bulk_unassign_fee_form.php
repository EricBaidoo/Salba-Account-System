...
<head>
    ...
    <title>Bulk Unassign Fees | Salba Montessori</title>
    ...
    <main class="admin-main-content lg:ml-72 p-4 md:p-8 min-h-screen">
        <header class="mb-8">
            ...
            <div class="flex justify-between items-end">
                <div>
                    <h1 class="text-3xl font-black text-slate-900 tracking-tight">Bulk Unassign <span class="text-indigo-600">Fees</span></h1>
                    <p class="text-slate-500 mt-1 font-medium text-sm">Target classes or students to bulk expunge fees from.</p>
                </div>
        ...
        <form action="bulk_unassign_fee.php" method="POST" class="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-8 max-w-4xl mx-auto mb-10" onsubmit="prepareSubmit()">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="assignmentType" name="assignment_type" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-700 outline-none focus:ring-2 focus:ring-indigo-500" onchange="toggleAssignmentType()">
                            <option value="whole_school">Whole School</option><option value="individual" <?= $preselected_student_id ? 'selected' : '' ?>>Individual Student</option>
                ...
                <!-- Setup Details -->
                <div class="space-y-6">
                    <h3 class="text-sm font-black text-slate-800 uppercase tracking-tight border-b border-slate-100 pb-3">2. Period Details</h3>
