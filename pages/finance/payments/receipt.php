...
<body class="clean-body">
    <div class="receipt-max-w-7xl mx-auto">
        ...
        <table class="w-full border-collapse receipt-w-full border-collapse">
            ...
            <tfoot>
                ...
                <tr class="outstanding-row">
                    <td colspan="2" class="text-right"><i class="fas fa-exclamation-triangle mr-2"></i>Outstanding Balance</td>
                    <td>GHâ‚µ<?php echo number_format($outstanding, 2); ?></td>
                </tr>
            </tfoot>
        </table>
        ...
        <button class="clean-px-3 py-2 rounded-primary clean-px-3 py-2 rounded-lg no-print w-full" onclick="window.print()">
